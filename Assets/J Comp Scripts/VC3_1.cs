...
public class VC3_1 : MonoBehaviour
{
    public string input;
    public string validInput;
    private GameObject myObject;
    public Vector2 pos3_1 ;
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode){
            ...
            myObject = GameObject.Find("Code Checkpoint 3_1");
            ...
            if(myObject != null && myPlayer != null){
                ...
                myPlayer.transform.position = pos3_1;
