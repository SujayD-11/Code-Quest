...
public class VC4_1 : MonoBehaviour
{
   public string input;
    public string validInput;
    private GameObject myObject;
    public Vector2 pos4_1 ;
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode){
            ...
            myObject = GameObject.Find("Code Checkpoint 4_1");
            ...
            if(myObject != null && myPlayer != null){
                ...
                myPlayer.transform.position = pos4_1;
