...
public class VC2_2 : MonoBehaviour
{
   public string input;
    public string validInput;
    private GameObject myObject;
    public Vector2 pos2_2 ;
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode){
            ...
            myObject = GameObject.Find("Code Checkpoint 2_2");
            ...
            if(myObject != null && myPlayer != null){
                ...
                myPlayer.transform.position = pos2_2;
